...
###### [ 1.0.219 ] - 2026/09/10
  ...
  * Updated `spotifywebapipython` package requirement to `spotifywebapipython>=1.0.293`.  
...
###### [ 1.0.209 ] - 2026/07/26
  ...
  * Updated `spotifywebapipython` package requirement to `spotifywebapipython>=1.0.281`.

###### [ 1.0.208 ] - 2026/07/25

  * Updated `spotifywebapipython` package requirement to `spotifywebapipython>=1.0.279`.
...
###### [ 1.0.177 ] - 2025/10/13
  ...
  * Updated `spotifywebapipython` package requirement to `spotifywebapipython>=1.0.251`.

###### [ 1.0.176 ] - 2025/10/12

  * Fixed service `get_image_palette_colors` argument `color_count` issue; accidentally changed it to `color_quality` in error.
...
###### [ 1.0.168 ] - 2025/09/27
  ...
  * Updated `spotifywebapipython` package requirement to `spotifywebapipython>=1.0.248`.
