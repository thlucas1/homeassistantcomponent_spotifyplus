...
class SpotifyPlusSearchPlayPlaylist_Handler(SpotifyPlusIntentHandler):
    """
    Handles intents for SpotifyPlusSearchPlayPlaylist.
    """
    def __init__(self, intentLoader:IntentLoader) -> None:
        ...
        self.intent_type = INTENT_SEARCH_PLAY_PLAYLIST
