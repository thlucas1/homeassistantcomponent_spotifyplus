...
class SpotifyPlusFavoriteTrackAdd_Handler(SpotifyPlusIntentHandler):
    """
    Handles intents for SpotifyPlusFavoriteTrackAdd.
    """
    def __init__(self, intentLoader:IntentLoader) -> None:
        ...
        self.description = "Adds the currently playing track to Spotify user track favorites."
        self.intent_type = INTENT_FAVORITE_TRACK_ADD
