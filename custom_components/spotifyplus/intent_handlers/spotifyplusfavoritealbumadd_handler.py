...
class SpotifyPlusFavoriteAlbumAdd_Handler(SpotifyPlusIntentHandler):
    """
    Handles intents for SpotifyPlusFavoriteAlbumAdd.
    """
    def __init__(self, intentLoader:IntentLoader) -> None:
        ...
        self.description = "Adds the currently playing track album to Spotify user album favorites."
        self.intent_type = INTENT_FAVORITE_ALBUM_ADD
