...
class SpotifyPlusVolumeDown_Handler(SpotifyPlusIntentHandler):
    """
    Handles intents for SpotifyPlusVolumeDown.
    """
    def __init__(self, intentLoader:IntentLoader) -> None:
        ...
        self.description = "Decrease volume by the specified volume step level amount for the specified SpotifyPlus media player."
        self.intent_type = INTENT_VOLUME_DOWN
