...
class SpotifyPlusSearchPlayTrack_Handler(SpotifyPlusIntentHandler):
    """
    Handles intents for SpotifyPlusSearchPlayTrack.
    """
    def __init__(self, intentLoader:IntentLoader) -> None:
        ...
        self.description = "Searches the Spotify catalog for a track name, and starts playing it if found."
        self.intent_type = INTENT_SEARCH_PLAY_TRACK
